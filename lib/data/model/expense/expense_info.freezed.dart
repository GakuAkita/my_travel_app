...
mixin _$ExpenseInfo {
 ...
 String? get id; TravelerCore get payer; Map<String, TravelerCore> get reimbursedBy; String get expenseItem;@JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson) double get expense;/* nameを変える場合はFirebaseDatabaseServiceも変えないとだめ */
...
@useResult
$Res call({
 String? id, TravelerCore payer, Map<String, TravelerCore> reimbursedBy, String expenseItem,@JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson) double expense,@JsonKey(name: 'createdAt', fromJson: _createdAtFromJson, toJson: _createdAtToJson) int? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  TravelerCore payer,  Map<String, TravelerCore> reimbursedBy,  String expenseItem, @JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson)  double expense, @JsonKey(name: 'createdAt', fromJson: _createdAtFromJson, toJson: _createdAtToJson)  int? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExpenseInfo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  TravelerCore payer,  Map<String, TravelerCore> reimbursedBy,  String expenseItem, @JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson)  double expense, @JsonKey(name: 'createdAt', fromJson: _createdAtFromJson, toJson: _createdAtToJson)  int? createdAt)  $default,) {final _that = this;
switch (_that) {
case _ExpenseInfo():
return $default(_that.id,_that.payer,_that.reimbursedBy,_that.expenseItem,_that.expense,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  TravelerCore payer,  Map<String, TravelerCore> reimbursedBy,  String expenseItem, @JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson)  double expense, @JsonKey(name: 'createdAt', fromJson: _createdAtFromJson, toJson: _createdAtToJson)  int? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ExpenseInfo() when $default != null:
return $default(_that.id,_that.payer,_that.reimbursedBy,_that.expenseItem,_that.expense,_that.createdAt);case _:
  return null;
...
class _ExpenseInfo implements ExpenseInfo {
  const _ExpenseInfo({required this.id, required this.payer, required final  Map<String, TravelerCore> reimbursedBy, required this.expenseItem, @JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson) required this.expense, @JsonKey(name: 'createdAt', fromJson: _createdAtFromJson, toJson: _createdAtToJson) this.createdAt}): _reimbursedBy = reimbursedBy;
...
@override@JsonKey(fromJson: _expenseFromJson, toJson: _expenseToJson) final  double expense;
